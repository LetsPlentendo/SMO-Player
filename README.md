...
I used the Fightstick library to perform the "Wet Nut Glitch" in Mario Odyssey (semi-)reliably. As the glitch requires quite accurate timing and I have basically no knowledge of C++ it will take multiple tries until it works.
